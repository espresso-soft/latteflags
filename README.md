...
<h1 align="center">Invalid JSON Edition</h1>

<h4 align="center"><a href="https://rentry.co/uffl">Third-party list</a></h4>
...
4. **Before you paste the text into `ClientAppSettings.json` Add `{` at the first line and then you can paste it, After that add `}` at the last line of the file. (You can utilize ChatGPT to format multiple JSONs for clarity if needed)**
